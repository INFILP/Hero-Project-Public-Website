  ...
  return (
    <>
      <main className="max-w-4xl mx-auto px-4 py-10 text-prime">
        <h1 className="text-3xl font-sfpro-bold text-second mb-6">
          TERMS OF SERVICE
        </h1>
        <p className="text-secondary text-sm mb-8 font-sfpro-regular">
          Last updated January 19, 2025
        </p>

        <h2 className="text-2xl font-sfpro-medium mt-8 mb-4">
          AGREEMENT TO OUR LEGAL TERMS
        </h2>
        <p className="text-secondary mb-4 font-sfpro-regular">
          We are GetMe LLC ("Company," "we," "us," "our"), a company registered
          in Colorado, United States at 121 Tejon Street, Suite 201, Colorado
          Springs, CO 80903.
        </p>
        <p className="text-secondary mb-4 font-sfpro-regular">
          We operate the mobile application The Hero Project (the "App"), as
        ...
        <p className="text-secondary mb-4 font-sfpro-regular">
          We provide an mobile app designed to facilitate communication among
        ...
        <p className="text-secondary mb-4 font-sfpro-regular">
          ...
          you, whether personally or on behalf of an entity ("you"), and GetMe
        ...
        <p className="text-secondary mb-4 font-sfpro-regular">
          ...
          upon posting or notifying you by info@teamheroproject.com, as stated
        ...
        <p className="text-secondary mb-6 font-sfpro-regular">
        ...
        <ol className="list-decimal list-inside mb-6 space-y-2 font-sfpro-regular">
          <li>
          ...
          <li>
            <a href="#ip-rights" className="text-blue-500">
              INTELLECTUAL PROPERTY RIGHTS
            </a>
          </li>
          <li>
            <a href="#user-reps" className="text-blue-500">
              USER REPRESENTATIONS
            </a>
          </li>
          <li>
            <a href="#user-reg" className="text-blue-500">
              USER REGISTRATION
            </a>
          </li>
          <li>
            <a href="#purchases" className="text-blue-500">
              PURCHASES AND PAYMENT
            </a>
          </li>
          <li>
            <a href="#subscriptions" className="text-blue-500">
              SUBSCRIPTIONS
            </a>
          </li>
          <li>
            <a href="#prohibited" className="text-blue-500">
              PROHIBITED ACTIVITIES
            </a>
          </li>
          <li>
            <a href="#ugc" className="text-blue-500">
          ...
          <li>
            <a href="#mobile" className="text-blue-500">
              MOBILE APPLICATION LICENSE
            </a>
          </li>
          <li>
            <a href="#third-party" className="text-blue-500">
              THIRD-PARTY WEBSITES AND CONTENT
            </a>
          </li>
          <li>
            <a href="#management" className="text-blue-500">
              SERVICES MANAGEMENT
            </a>
          </li>
          <li>
          ...
          <li>
            <a href="#copyright" className="text-blue-500">
              COPYRIGHT INFRINGEMENTS
            </a>
          </li>
          <li>
            <a href="#term" className="text-blue-500">
              TERM AND TERMINATION
            </a>
          </li>
          <li>
            <a href="#modifications" className="text-blue-500">
              MODIFICATIONS AND INTERRUPTIONS
            </a>
          </li>
          <li>
            <a href="#law" className="text-blue-500">
              GOVERNING LAW
            </a>
          </li>
          <li>
            <a href="#disputes" className="text-blue-500">
              DISPUTE RESOLUTION
            </a>
          </li>
          <li>
            <a href="#corrections" className="text-blue-500">
              CORRECTIONS
            </a>
          </li>
          <li>
          ...
          <li>
            <a href="#liability" className="text-blue-500">
              LIMITATIONS OF LIABILITY
            </a>
          </li>
          <li>
            <a href="#indemnification" className="text-blue-500">
              INDEMNIFICATION
            </a>
          </li>
          <li>
            <a href="#user-data" className="text-blue-500">
              USER DATA
            </a>
          </li>
          <li>
            <a href="#electronic" className="text-blue-500">
              ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES
            </a>
          </li>
          <li>
            <a href="#sms" className="text-blue-500">
              SMS TEXT MESSAGING
            </a>
          </li>
          <li>
            <a href="#california" className="text-blue-500">
              CALIFORNIA USERS AND RESIDENTS
            </a>
          </li>
          <li>
            <a href="#misc" className="text-blue-500">
              MISCELLANEOUS
            </a>
          </li>
          <li>
        ...
        {/* Section 1 */}
        <h2 id="services" className="text-2xl font-sfpro-medium mt-8 mb-4">
          1. OUR SERVICES
        </h2>
        <p className="text-secondary mb-4 font-sfpro-regular">
        ...
        {/* Section 2 */}
        <h2 id="ip-rights" className="text-2xl font-sfpro-medium mt-8 mb-4">
          2. INTELLECTUAL PROPERTY RIGHTS
        </h2>
        <h3 className="text-prime text-xl font-sfpro-medium mt-6 mb-2">
        ...
        <ul className="list-disc list-inside mb-4 space-y-2 font-sfpro-regular text-secondary">
        ...
        <p className="text-secondary mb-4 font-sfpro-regular">
          <span className="font-sfpro-medium">Submissions:</span> By directly
        ...
        <p className="text-secondary mb-4 font-sfpro-regular">
          <span className="font-sfpro-medium">Contributions:</span> The Services
        ...
        <p className="text-secondary mb-4 font-sfpro-regular">
          <span className="font-sfpro-medium">
        ...
        <p className="text-secondary mb-4 font-sfpro-regular">
          <span className="font-sfpro-medium">Copyright infringement</span>
          <br />
        ...
        {/* Section 3 */}
        <h2 id="user-reps" className="text-2xl font-sfpro-medium mt-8 mb-4">
        ...
        {/* Section 4 */}
        <h2 id="user-reg" className="text-2xl font-sfpro-medium mt-8 mb-4">
          4. USER REGISTRATION
        </h2>
        <p className="text-secondary mb-4 font-sfpro-regular">
        ...
        {/* Section 5 */}
        <h2 id="purchases" className="text-2xl font-sfpro-medium mt-8 mb-4">
        ...
        {/* Section 6 */}
        <h2 id="subscriptions" className="text-2xl font-sfpro-medium mt-8 mb-4">
          6. SUBSCRIPTIONS
        </h2>
        <h3 className="text-prime text-xl font-sfpro-medium mt-6 mb-2">
          Billing and Renewal
        ...
        {/* Section 7 */}
        <h2 id="prohibited" className="text-2xl font-sfpro-medium mt-8 mb-4">
        ...
        {/* Section 8 */}
        <h2 id="ugc" className="text-2xl font-sfpro-medium mt-8 mb-4">
        ...
        {/* Section 9 */}
        <h2 id="license" className="text-2xl font-sfpro-medium mt-8 mb-4">
        ...
        {/* Section 10 */}
        <h2 id="mobile" className="text-2xl font-sfpro-medium mt-8 mb-4">
        ...
        {/* Section 11 */}
        <h2 id="third-party" className="text-2xl font-sfpro-medium mt-8 mb-4">
        ...
        {/* Section 12 */}
        <h2 id="management" className="text-2xl font-sfpro-medium mt-8 mb-4">
        ...
        {/* Section 13 */}
        <h2 id="privacy" className="text-2xl font-sfpro-medium mt-8 mb-4">
          13. PRIVACY POLICY
        </h2>
        <p className="text-secondary mb-4 font-sfpro-regular">
          We care about data privacy and security. Please review our Privacy
          Policy:{" "}
          <a href="www.teamheroproject/privacy" className="text-blue-500">
            www.teamheroproject/privacy
          </a>
        ...
        {/* Section 14 */}
        <h2 id="copyright" className="text-2xl font-sfpro-medium mt-8 mb-4">
        ...
        {/* Section 15 */}
        <h2 id="term" className="text-2xl font-sfpro-medium mt-8 mb-4">
        ...
        {/* Section 16 */}
        <h2 id="modifications" className="text-2xl font-sfpro-medium mt-8 mb-4">
        ...
        {/* Section 17 */}
        <h2 id="law" className="text-2xl font-sfpro-medium mt-8 mb-4">
          17. GOVERNING LAW
        </h2>
        <p className="text-secondary mb-4 font-sfpro-regular">
        ...
        {/* Section 18 */}
        <h2 id="disputes" className="text-2xl font-sfpro-medium mt-8 mb-4">
        ...
        <p className="text-secondary mb-4 font-sfpro-regular">
          ...
          rules or applicable law, the arbitration will take place in Boulder,
          Colorado. Except as otherwise provided herein, the Parties may
        ...
        <p className="text-secondary mb-4 font-sfpro-regular">
          ...
          and federal courts located in Boulder, Colorado, and the Parties
        ...
        {/* Section 19 */}
        <h2 id="corrections" className="text-2xl font-sfpro-medium mt-8 mb-4">
          19. CORRECTIONS
        </h2>
        <p className="text-secondary mb-4 font-sfpro-regular">
        ...
        {/* Section 20 */}
        <h2 id="disclaimer" className="text-2xl font-sfpro-medium mt-8 mb-4">
          20. DISCLAIMER
        </h2>
        <p className="text-secondary mb-4 font-sfpro-regular">
        ...
        {/* Section 21 */}
        <h2 id="liability" className="text-2xl font-sfpro-medium mt-8 mb-4">
        ...
        <h2
          id="indemnification"
          className="text-2xl font-sfpro-medium mt-8 mb-4"
        >
          22. INDEMNIFICATION
        </h2>
        <p className="text-secondary mb-4 font-sfpro-regular">
        ...
        {/* Section 23 */}
        <h2 id="user-data" className="text-2xl font-sfpro-medium mt-8 mb-4">
          23. USER DATA
        </h2>
        <p className="text-secondary mb-4 font-sfpro-regular">
        ...
        {/* Section 24 */}
        <h2 id="electronic" className="text-2xl font-sfpro-medium mt-8 mb-4">
        ...
        {/* Section 25 */}
        <h2 id="sms" className="text-2xl font-sfpro-medium mt-8 mb-4">
        ...
        {/* Section 26 */}
        <h2 id="california" className="text-2xl font-sfpro-medium mt-8 mb-4">
        ...
        {/* Section 27 */}
        <h2 id="misc" className="text-2xl font-sfpro-medium mt-8 mb-4">
          27. MISCELLANEOUS
        </h2>
        <p className="text-secondary mb-4 font-sfpro-regular">
        ...
        {/* Section 28 */}
        <h2 id="contact" className="text-2xl font-sfpro-medium mt-8 mb-4">
          28. CONTACT US
        </h2>
        <p className="text-secondary mb-4 font-sfpro-regular">
