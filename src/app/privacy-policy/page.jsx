    ...
    <>
      <main className="max-w-4xl mx-auto px-4 py-10 text-prime">
        ...
        <p className=" text-secondary mb-6 font-sfpro-regular">
          This Privacy Notice for GetMe LLC ("we," "us," or "our"), describes
        ...
        <ul className="text-secondary list-disc list-inside mb-6 space-y-2 font-sfpro-regular">
          <li>
            Download and use our mobile application (The Hero Project), or any
            other application of ours that links to this Privacy Notice
          </li>
          <li>
            Use The Hero Project. A mobile app designed to facilitate
            communication among family and friends caring for a loved one.
          </li>
          <li>
        ...
        <p className=" text-secondary mb-6 font-sfpro-regular">
          ...
          contact us at{" "}
          <a
            href="mailto:privacy@teamheroproject.com"
            className="text-blue-500"
          >
            privacy@teamheroproject.com
          </a>
          .
        </p>

        <h2 className="text-prime text-2xl font-sfpro-bold mt-8 mb-4">
        ...
        <ul className="text-secondary list-disc list-inside mb-6 space-y-2 font-sfpro-regular">
          <li>
            ...
            <a href="#info-collect" className="text-blue-500">
          ...
          <li>
            <strong className="font-sfpro-bold">
          ...
          <li>
            ...
            <a href="#process-info" className="text-blue-500">
          ...
          <li>
            ...
            <a href="#share-info" className="text-blue-500">
          ...
          <li>
            ...
            <a href="#info-safe" className="text-blue-500">
              how we keep your information safe.
            </a>
          </li>
          <li>
            <span className="font-sfpro-bold">What are your rights?</span>{" "}
            Depending on where you are located geographically, the applicable
            privacy law may mean you have certain rights regarding your personal
            information. Learn more about{" "}
            <a href="#privacy-rights" className="text-blue-500">
              your privacy rights.
            </a>
          </li>
          <li>
            ...
            laws.{" "}
            <a href="#review" className="text-blue-500">
              Learn more
            </a>
          </li>
          <li>
        ...
        <ol className="list-decimal list-inside mb-6 space-y-2 font-sfpro-regular">
          ...
          <li>
            <a href="#legal-bases" className="text-blue-500">
          ...
          <li>
            <a href="#keep-info" className="text-blue-500">
          ...
          <li>
            <a href="#minors" className="text-blue-500">
          ...
          <li>
            <a href="#dnt" className="text-blue-500">
              CONTROLS FOR DO-NOT-TRACK FEATURES
            </a>
          </li>
          <li>
            <a href="#us-rights" className="text-blue-500">
              DO UNITED STATES RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS?
            </a>
          </li>
          <li>
            <a href="#updates" className="text-blue-500">
        ...
        {/* Section 1 */}
        <h2 id="info-collect" className="text-2xl font-sfpro-bold mt-8 mb-4">
          1. WHAT INFORMATION DO WE COLLECT?
        </h2>
        <h3 className="text-prime text-xl font-sfpro-medium mt-6 mb-2">
          Personal information you disclose to us
        </h3>
        <p className=" text-secondary mb-4 font-sfpro-medium">
        ...
        <p className=" text-secondary mb-2 font-sfpro-regular">
          <span className="font-sfpro-medium">
        ...
        <ul className="text-secondary list-disc list-inside mb-4 space-y-2 font-sfpro-regular">
          <li>names</li>
          <li>phone numbers</li>
        ...
        <p className=" text-secondary mb-4 font-sfpro-regular">
          <span className="font-sfpro-medium">Sensitive Information:</span> We
          do not process sensitive information.
        </p>

        <p className=" text-secondary mb-2 font-sfpro-regular">
          <span className="font-sfpro-medium">Application Data:</span> If you
        ...
        <ul className="text-secondary list-disc list-inside mb-4 space-y-2 font-sfpro-regular">
          <li>
            ...
            contacts, camera, and other features. If you wish to change our
        ...
        {/* Section 2 */}
        <h2 id="process-info" className="text-2xl font-sfpro-bold mt-8 mb-4">
        ...
        {/* Section 3 */}
        <h2 id="legal-bases" className="text-2xl font-sfpro-bold mt-8 mb-4">
        ...
        <ul className="text-secondary list-disc list-inside mb-4 space-y-2 font-sfpro-regular">
          <li>
            <span className="font-sfpro-medium">Consent.</span> We may process
          ...
          <li>
            <span className="font-sfpro-medium">Legal Obligations.</span> We may
          ...
          <li>
            <span className="font-sfpro-medium">Vital Interests.</span> We may
        ...
        {/* Section 4 */}
        <h2 id="share-info" className="text-2xl font-sfpro-bold mt-8 mb-4">
        ...
        <ul className="text-secondary list-disc list-inside mb-4 space-y-2 font-sfpro-regular">
          <li>
            <span className="font-sfpro-medium">Business Transfers.</span> We
            may share or transfer your information in connection with, or during
            negotiations of, any merger, sale of company assets, financing, or
            acquisition of all or a portion of our business to another company.
          </li>
          <li>
            <span className="font-sfpro-medium">Affiliates.</span> We may share
          ...
          <li>
            <span className="font-sfpro-medium">Business Partners.</span> We may
            share your information with our business partners to offer you
            certain products, services, or promotions.
          </li>
          <li>
            <span className="font-sfpro-medium">Other Users.</span> When you
        ...
        {/* Section 5 */}
        <h2 id="third-party" className="text-2xl font-sfpro-bold mt-8 mb-4">
        ...
        {/* Section 6 */}
        <h2 id="cookies" className="text-2xl font-sfpro-bold mt-8 mb-4">
        ...
        {/* Section 7 */}
        <h2 id="keep-info" className="text-2xl font-sfpro-bold mt-8 mb-4">
        ...
        {/* Section 8 */}
        <h2 id="info-safe" className="text-2xl font-sfpro-bold mt-8 mb-4">
        ...
        {/* Section 9 */}
        <h2 id="minors" className="text-2xl font-sfpro-bold mt-8 mb-4">
        ...
        {/* Section 10 */}
        <h2 id="privacy-rights" className="text-2xl font-sfpro-bold mt-8 mb-4">
        ...
        <p className=" text-secondary mb-4 font-sfpro-regular">
          <span className="font-sfpro-medium">Withdrawing your consent:</span>{" "}
        ...
        <p className=" text-secondary mb-4 font-sfpro-regular">
          <span className="font-sfpro-medium">Account Information</span>
          <br />
        ...
        {/* Section 11 */}
        <h2 id="dnt" className="text-2xl font-sfpro-bold mt-8 mb-4">
        ...
        {/* Section 12 */}
        <h2 id="us-rights" className="text-2xl font-sfpro-bold mt-8 mb-4">
        ...
        {/* Section 13 */}
        <h2 id="updates" className="text-2xl font-sfpro-bold mt-8 mb-4">
        ...
        {/* Section 14 */}
        <h2 id="contact" className="text-2xl font-sfpro-bold mt-8 mb-4">
        ...
        {/* Section 15 */}
        <h2 id="review" className="text-2xl font-sfpro-bold mt-8 mb-4">
